...
class free_volume_GUI:
    ...
    def quickhelp(self):
        try: # Try to get text from GUI_help_page.txt file
            txt = os.path.join(self.pwd, 'src/GUI_quick_help_pages/free_volume.txt')
            logged = []
            ...
            logged.append('FAILED to read LUNAR/src/GUI_quick_help_pages/free_volume.txt document.')
            logged.append('Most likely cause is the free_volume.txt file was renamed in the')
