...
analysis = [['LAMMPS data (apply Butterworth filter)', '', '', 'qm=msr; psd=False; csv=False; savefig=all; order=2; wn=op', 'LAMMPS Butterworth Filter'],
            ['Regression Fringe Response Modulus', '', '', 'shift=ymin; minxhi=0.005; maxxhi=0.0; xlo=rfs; yp=1; offset=0.0; t1=v_etruey; t2=v_etruez; csv=False; savefig=all', 'Modulus']]

# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/tensile_1*.log.lammps',
        'keywords': ['Step', 'Temp'],
        'sections': '1',
        'xdata': 'v_etruex',
        'ydata': 'f_sxx_ave',
        ...
        'analysis': analysis,
        'nevery': '1',
        'parent_directory': 'logfile/array_test_1'
        }
