...
analysis = [['LAMMPS data (apply Whittaker-Eilers)', '', '', 'order=2; lambda=op<1e-2, 1e12, 50>-p', 'LAMMPS Whittaker-Eilers'],
            ['Regression Fringe Response Modulus', '', '', 'shift=ymin; minxhi=0.01; maxxhi=0.04; xlo=rfs; yp=1; csv=False; savefig=all', 'Modulus']]

# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/shear_1_EPON_862_pxld_88.2_replicate_1_FF_PCFF-class2xe.log.lammps',
        'keywords': ['Step', 'Temp'],
        'sections': '1',
        'xdata': 'v_etruexy',
        'ydata': '',
