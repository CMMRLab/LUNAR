...
"""
# analysis list
analysis = [['LAMMPS data (apply Whittaker-Eilers)', '', '', 'order=2; lambda=1_500', 'Whittaker-Eilers'],
...
# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/regression_fringe_response_example_4.txt',
