...
"""
# analysis list
analysis = [['LAMMPS data (fit polynomial)', '', '', 'deg=100', 'Polynomial'],
            ['LAMMPS data (apply Whittaker-Eilers)', '', '', 'order=2; lambda=50_000', 'Whittaker-Eilers'],
...
# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/regression_fringe_response_example_1.txt',
