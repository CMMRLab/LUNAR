...
"""
# analysis list
analysis = [['LAMMPS data (apply iFFT filter)', '', '', 'qm=msr-p; threshold=mean:1.0; savefig=all', 'iFFT Filter'],
            ['Regression Fringe Response Modulus', '', '', 'shift=ymin; minxhi=0.0025; maxxhi=0.0; xlo=rfs; yp=1; offset=0.0; t1=v_etruey; t2=v_etruez; csv=False; savefig=all', 'Modulus']]
