...
# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/property=shear_modulus_xy_strain_rate=2e8.log.lammps',
        'keywords': ['Step', 'Temp'],
        'sections': '1',
        'xdata': 'v_etruexy',
        'ydata': '',
        ...
        'xcompute': 'reversed(${v_etruexy})',
        'ycompute': f'reversed({svm})', # use variable from above since this is a long equation,
        'analysis': analysis,
        'nevery': '1',
