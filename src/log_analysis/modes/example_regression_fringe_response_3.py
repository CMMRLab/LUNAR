...
"""
# analysis list
analysis = [['LAMMPS data (apply Whittaker-Eilers)', '', '', 'order=2; lambda=1_750', 'Whittaker-Eilers'],
...
# loadable mode
mode = {'logfile': 'EXAMPLES/log_analysis/regression_fringe_response_example_3.txt',
