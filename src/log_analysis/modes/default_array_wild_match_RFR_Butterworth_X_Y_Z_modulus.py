...
mode = {'logfile': 'EXAMPLES/log_analysis/tensile_*_*_pxld_*_replicate_*_FF_*.log.lammps',
        ...
        'xcompute': 'wild_match( wildcards[0]=1=v_etruex; t1=v_etruey; t2=v_etruez,   wildcards[0]=2=v_etruey; t1=v_etruex; t2=v_etruez,   wildcards[0]=3=v_etruez; t1=v_etruex; t2=v_etruey  )',
        'ycompute': 'wild_match( wildcards[0]=1=f_sxx_ave,                            wildcards[0]=2=f_syy_ave,                            wildcards[0]=3=f_szz_ave )',
        'analysis': analysis,
        'nevery': '1',
        'parent_directory': 'logfile/array_wild_match_RFR_tensile',
