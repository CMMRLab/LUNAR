...
analysis = [['LAMMPS data (LOWESS)', '', '', 'fraction=0.01; max_iter=30', 'LOWESS'],
            ...
            ['Regression Fringe Response Modulus', '', 0.25, 'shift=ymin; minxhi=0.000; maxxhi=0.0; xlo=rfs; yp=mean(r2)-3s; offset=0.0; t1=trans; t2=trans; csv=True; ci=0.95', 'Modulus'],
