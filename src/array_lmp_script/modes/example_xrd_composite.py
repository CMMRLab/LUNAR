...
lmp_array = {'$<replicate>': '[1, 2]',
             '$<atomic_frac>': [0.0, 0.5, 1.0],
             '$<amorphous_density>': [0.125, 0.25]}
...
copy_files = ['*-atom.lmpmol', 'graphite_AB_25x25x25_PCFF.data']


# The full mode dictionary
mode = {'lmp_script': 'EXAMPLES/array_lmp_script/xrd_composite/atomic_fraction_XRD.script',
