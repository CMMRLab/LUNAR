...
copy_files = ['Replicate_$<replicate>_reset/EPON_862_cell_builder_random_replicate_$<replicate>_pxld_$<pxld>_PCFF.data']


# loadable mode
mode = {'lmp_script': '../LUNAR_versions/Manuscript_models/epoxy/n1_relax_PCFF.template',
        'batch_script': '$<lmp_script>.sh',
        'auto_script': 'auto_submit_$<lmp_script>',
        'build_script': '$<lmp_script>.script',
        'build_directory': 'Replicate_$<replicate>/relax_$<pxld>',
