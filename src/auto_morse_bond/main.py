...
def main(topofile, morsefile, parent_directory, newfile, mass_map, min_bond_length, coeffs2skip, radius_specs, alpha_specs, alpha_scale, files2write, atom_style,
         zero_effected_xterms, bondbreak_scale, ff_class, include_type_labels, include_rcut, commandline_inputs=[], log=None):
    ...
    m.plotting = potential_plotting.figure(m, radius, m.bond_info, basename, files2write, version, bondbreak_scale, ff_class)
