...
# logger string
logger = """
filename,    numeric,    wildcards,    mass,    %Ring-Count:6,    %Ring-Count:C6,    %Hybrid-Mass:Sp1-C
%Hybrid-Mass:Sp2-C,   %Hybrid-Mass:Sp3-C,   %Hybrid-Count:all-C,    mass,    %Hybrid-Count:all-H
"""
