...
echo "Test4: classi for ReaxFF, REBO, SNAP, ... and all CLI options"
FF="frc_files/all2lmp_interatomic.frc"
NEWFILE=":_ReaxFF_interatomic_test"
ASM="frc_files/general_assumed_equivs.coeffs"
TOPO="EXAMPLES/EPON_862/atom_typing_Inputs/detda.mol"
NTA="empty.nta"
$PYTHON all2lmp.py -dir $DIR -class i -frc $FF -newfile $NEWFILE -topo $TOPO -nta $NTA -ignore T \
...
echo "Test10: class2 equivs and removing things and all CLI options"
FF="frc_files/pcff.frc"
NEWFILE=":_PCFF_equivs_and_removing_test"
ASM="frc_files/general_assumed_equivs.coeffs"
TOPO="EXAMPLES/nta_topo_remove/Fullerene-C60_pi_electrons_typed.data"
NTA="EXAMPLES/nta_topo_remove/Fullerene-C60_pi_electrons_typed.nta"
$PYTHON all2lmp.py -dir $DIR -class 2 -frc $FF -newfile $NEWFILE -topo $TOPO -nta $NTA -ignore T \
                   -type-labels T -reset-charges T -atomstyle full -auto-equivs T -asm $ASM -assumed-equivs F \
				   -reset-molids T -write-comments T -write-bond-react T -morse-bond F -rx 45 -ry 45 -rz 45 \
				   -sx 10 -sy 20 -sz 30 -add2box 5
				   
echo "Test11: class2 atom naming and all CLI options"
FF="frc_files/pcff.frc"
NEWFILE=":_PCFF_atom_naming_test"
ASM="frc_files/general_assumed_equivs.coeffs"
TOPO="EXAMPLES/all2lmp_atom_naming/detda_typed.data"
NTA="EXAMPLES/all2lmp_atom_naming/detda_typed.nta"
$PYTHON all2lmp.py -dir $DIR -class 2 -frc $FF -newfile $NEWFILE -topo $TOPO -nta $NTA -ignore T \
                   -type-labels T -reset-charges T -atomstyle full -auto-equivs T -asm $ASM -assumed-equivs F \
				   -reset-molids T -write-comments T -write-bond-react T -morse-bond F -rx 45 -ry 45 -rz 45 \
				   -sx 10 -sy 20 -sz 30 -add2box 5
